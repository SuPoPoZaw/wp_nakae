    ...
    <div class="container m-w800">
        ...
        <div class="">
            ...
            <div>
                ...
                <p class="common-txt-po mt5"><span>※</span>1日の流れや行事予定は、園児数や年齢構成によりやむを得ず変更する場合があります</p>
            </div>
            <div>
                <h4 class="pro-sub-ttl" id="nursery-school04">給食について</h4>
                <div class="nakae">
                    <ul>
                        <li>昼食については、当院院内の栄養課により配膳されます（月～金）</li>
                        <li>希望者はお弁当持参も可能です</li>
                        <li>午前、午後のおやつ、水分の補給は保育所で行います</li>
                    </ul>
                </div>
            </div>
            <div>
