    ...
    <section id="dept-sec02" class="item02-sec item-sec-border-sp">
        <div class="container m-w800">
            ...
            <div class="nakae mb50 mb30-sp">
                ...
                <ul class="mt15">
                    <li>心身の健康状態の確認と助言・・・辛いこと、気になること、前よりよくなったこと</li>
                    <li>お薬についての確認・・・お薬をより効果的に利用できるように</li>
                    <li>生活の相談・・・身の回りの家事全般に関することや周囲の対人関係等でお困りのこと</li>
                    <li>各種サービスの相談・・・介護保険、精神関連についての情報提供や関係機関との調整</li>
                </ul>
            </div>
            <div class="mb50 mb30-sp">
        ...
        <div class="container m-w800">
            ...
            <div class="procedure-con">
                ...
                <div class="nakae mb50 mb30-sp">
                    ...
                    <ul class="mt15">
                        <li>医療費、生活費などの経済的な問題について</li>
                        <li>自立支援、介護保険などの制度について</li>
                        <li>介護施設、福祉施設などについて</li>
                        <li>生活、仕事、療養上の不安や心配事について</li>
                        <li>その他、どこに相談したらよいのかわからない事についてなど</li>
                    </ul>
        ...
        <div class="container m-w800">
            ...
            <div class="procedure-con">
                ...
                <div class=" nakae mb50 mb30-sp">
                    ...
                    <ul class="mt15 mt10-sp">
                        <li>気分が落ち込む（または、イライラする）</li>
                        <li>興味や関心が薄れた</li>
                        <li>体重が減った（食欲がなくなった）、もしくは増えた</li>
                        <li>眠れない、もしくは寝すぎてしまう</li>
                        <li>落ち着きがなかったり、動作が緩慢になった</li>
                        <li>疲れやすい、気力がわかない</li>
                        <li>嫌なことを考えだすと止まらなくなる</li>
                        <li>ばかばかしいと思うのに、やめられないことがある</li>
                        <li>他の人に悪く思われてるのではないかとても心配する</li>
                        <li>大変なことが起きる気がして、外出するのが怖い</li>
                        <li>人前で注目を集める状況が不安・恐ろしい</li>
                    </ul>
                </div>
    ...
    <section id="dept-sec05" class="item05-sec item-sec-border-sp bg-gray">
        ...
        <div class="container m-w800">
            ...
            <div class="nakae mb50 mb30-sp">
                ...
                <ul class="mt15 mt10-sp">
                    <li>毎日同じ時間に参加することによって生活リズムを整える</li>
                    <li>様々な活動に参加することで新たな趣味・楽しみを見つける</li>
                    <li>多くの人と接することで人付き合いの練習をする</li>
                    <li>運動不足を解消し、体を動かす機会とする</li>
                    <li>長期の入院で忘れてしまった感覚を思い出し、改めて経験・獲得する</li>
                    <li>退院に向けて必要な知識や経験を得ることで不安を解消する</li>
                </ul>
